...
import static clean.cleanarchitecture.buckpal.account.domain.Activity.*;
...
public class AccountMapper {
    ...
    Account mapToDomainEntity(AccountJpaEntity account,
        ...
        Money baselineBalance = Money.subtract(Money.of(depositBalance),
                                               Money.of(withdrawalBalance));

        return withId(new AccountId(account.getId()),
                baselineBalance, mapToActivityWindow(activities));
